...
var schools : Array = ['Enchanter', 'Priest', 'Sorcerer']

# Fuction of target type, effect (phase), and line of sight
var targettile : int = 0  #0=anywhere 1=creature 2=empty 3=nowall

var school_levels : Dictionary = {"Sorcerer": 4, "Priest": 2, "Enchanter": 1}
var selection_costs : Dictionary = {"Sorcerer": 10, "Priest": 3, "Enchanter": 1}
