var name : String = 'Creature Summon 2'
...
var school_levels : Dictionary = {"Sorcerer": 6, "Priest": 0, "Enchanter": 3}
var selection_costs : Dictionary = {"Sorcerer": 21, "Priest": 0, "Enchanter": 6}
