...
var school_levels : Dictionary = {"Sorcerer": 4, "Priest": 7, "Enchanter": 3}
var selection_costs : Dictionary = {"Sorcerer": 10, "Priest": 28, "Enchanter": 6}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = false
var in_combat : bool = true
var description : String = 'Power Drain:  Will drain spell points from the target.'
...
var sounds : Array = ['boing.wav', 'electric energize.wav']
