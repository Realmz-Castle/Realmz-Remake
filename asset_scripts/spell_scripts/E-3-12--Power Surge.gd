...
var school_levels : Dictionary = {"Sorcerer": 4, "Priest": 0, "Enchanter": 3}
var selection_costs : Dictionary = {"Sorcerer": 10, "Priest": 0, "Enchanter": 6}
