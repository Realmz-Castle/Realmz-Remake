var name : String = 'Creature Summon 3'
...
var school_levels : Dictionary = {"Sorcerer": 7, "Priest": 0, "Enchanter": 4}
var selection_costs : Dictionary = {"Sorcerer": 28, "Priest": 0, "Enchanter": 10}
