var name : String = 'Major Vorpal Plate'
...
var school_levels : Dictionary = {"Sorcerer": 0, "Priest": 0, "Enchanter": 4}
var selection_costs : Dictionary = {"Sorcerer": 0, "Priest": 0, "Enchanter": 10}
