var name : String = 'Statue'

var attributes : Array = ['Magical','Special']
var tags : Array = ['Magical']

var schools : Array = ['Enchanter', 'Priest']

# Fuction of target type, effect (phase), and line of sight
var targettile : int = 3  #0=anywhere 1=creature 2=empty 3=nowall

var school_levels : Dictionary = {"Sorcerer": 0, "Priest": 6, "Enchanter": 4}
var selection_costs : Dictionary = {"Sorcerer": 0, "Priest": 21, "Enchanter": 10}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = false
var in_combat : bool = true
var description : String = 'Statue:  Will cause the flesh of the target to turn to solid stone.  This will kill any creature.  The only way to bring back a character from this condition is to have Flesh cast on them.'
