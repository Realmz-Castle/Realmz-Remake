var name : String = 'Destroy / Turn Undead'
...
var school_levels : Dictionary = {"Sorcerer": 0, "Priest": 0, "Enchanter": 5}
var selection_costs : Dictionary = {"Sorcerer": 0, "Priest": 0, "Enchanter": 15}
