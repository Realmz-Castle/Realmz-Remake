var name : String = 'Heal Small Wounds'

var attributes : Array = ['Magical','Misc']
var tags : Array = ['Magical','Healing']

var schools : Array = ['Priest', 'Special/Potion', 'Sorcerer']

# Fuction of target type, effect (phase), and line of sight
var targettile : int = 3  #0=anywhere 1=creature 2=empty 3=nowall

var school_levels : Dictionary = {"Sorcerer": 5, "Priest": 1, "Enchanter": 0}
var selection_costs : Dictionary = {"Sorcerer": 15, "Priest": 1, "Enchanter": 0}
