...
var school_levels : Dictionary = {"Sorcerer": 0, "Priest": 1, "Enchanter": 2}
var selection_costs : Dictionary = {"Sorcerer": 0, "Priest": 1, "Enchanter": 3}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = true
var in_combat : bool = true
var description : String = 'Vorpal Plate:  Will make those affected harder to hit in battle.'
