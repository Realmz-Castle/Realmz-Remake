var name : String = 'Heal Blindness'
...
var school_levels : Dictionary = {"Sorcerer": 0, "Priest": 2, "Enchanter": 2}
var selection_costs : Dictionary = {"Sorcerer": 0, "Priest": 3, "Enchanter": 3}
