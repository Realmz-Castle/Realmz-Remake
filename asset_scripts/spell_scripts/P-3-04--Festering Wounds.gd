var name : String = 'Festering Wounds'
...
var school_levels : Dictionary = {"Sorcerer": 0, "Priest": 3, "Enchanter": 0}
var selection_costs : Dictionary = {"Sorcerer": 0, "Priest": 6, "Enchanter": 0}
