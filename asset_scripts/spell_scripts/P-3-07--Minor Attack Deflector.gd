...
var school_levels : Dictionary = {"Sorcerer": 4, "Priest": 3, "Enchanter": 4}
var selection_costs : Dictionary = {"Sorcerer": 10, "Priest": 6, "Enchanter": 10}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = true
var in_combat : bool = true
var description : String = 'Minor Attack Deflector'
