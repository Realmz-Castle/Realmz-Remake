var name : String = 'Minor Spell Deflector'
...
var school_levels : Dictionary = {"Sorcerer": 5, "Priest": 4, "Enchanter": 5}
var selection_costs : Dictionary = {"Sorcerer": 15, "Priest": 10, "Enchanter": 15}
