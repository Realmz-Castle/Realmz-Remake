var name : String = 'Puppet Master'

var attributes : Array = ['Magical','Special']
var tags : Array = ['Magical']

var schools : Array = ['Priest', 'Enchanter']

# Fuction of target type, effect (phase), and line of sight
var targettile : int = 3  #0=anywhere 1=creature 2=empty 3=nowall

var school_levels : Dictionary = {"Sorcerer": 0, "Priest": 4, "Enchanter": 6}
var selection_costs : Dictionary = {"Sorcerer": 0, "Priest": 10, "Enchanter": 21}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = true
var in_combat : bool = false
var description : String = 'Puppet Master:  Will cause dead characters to become animated, (Like a Zombie).  They will not gain any victory points while animated and cannot use spells or missile weapons.'
...
var sounds : Array = ['drippity beep.wav', 'resurrect death.wav']
