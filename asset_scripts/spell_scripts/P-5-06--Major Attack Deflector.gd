var name : String = 'Major Attack Deflector'
...
var school_levels : Dictionary = {"Sorcerer": 6, "Priest": 5, "Enchanter": 6}
var selection_costs : Dictionary = {"Sorcerer": 21, "Priest": 15, "Enchanter": 21}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = true
var in_combat : bool = true
var description : String = 'Major Attack Deflector:  Same as minor attack deflector but with improved targeting ability.'
...
var sounds : Array = ['jump.wav', 'hit effect 1.wav']
...
static func add_traits_to_target(_casterchar : Creature, _targetcbbutton, _power):
	...
	var trait_array : Array = [_power, 33]
