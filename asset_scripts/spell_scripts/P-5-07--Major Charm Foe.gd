var name : String = 'Major Charm Foe'
...
var school_levels : Dictionary = {"Sorcerer": 6, "Priest": 5, "Enchanter": 0}
var selection_costs : Dictionary = {"Sorcerer": 21, "Priest": 15, "Enchanter": 0}
