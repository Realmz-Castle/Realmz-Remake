var name : String = 'Multi Invisible Skin'
...
var school_levels : Dictionary = {"Sorcerer": 7, "Priest": 5, "Enchanter": 0}
var selection_costs : Dictionary = {"Sorcerer": 28, "Priest": 15, "Enchanter": 0}
