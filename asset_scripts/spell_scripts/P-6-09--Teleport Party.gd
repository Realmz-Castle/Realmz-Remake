var name : String = 'Teleport Party'
...
var school_levels : Dictionary = {"Sorcerer": 0, "Priest": 6, "Enchanter": 7}
var selection_costs : Dictionary = {"Sorcerer": 0, "Priest": 21, "Enchanter": 28}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = false
var in_combat : bool = false
var description : String = 'Teleport Party:  Will allow the party to teleport to a specific area.  This spell can only be used in special encounters.'
