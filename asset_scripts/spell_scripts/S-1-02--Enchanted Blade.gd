...
var school_levels : Dictionary = {"Sorcerer": 1, "Priest": 0, "Enchanter": 1}
var selection_costs : Dictionary = {"Sorcerer": 1, "Priest": 0, "Enchanter": 1}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = true
var in_combat : bool = true
var description : String = 'Enchanted Blade:  Will cause the target to cause more damage during combat.  The target does not need to possess a weapon.  It will cause even those that are using their bare hands to cause more damage.'
