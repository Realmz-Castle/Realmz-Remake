...
var school_levels : Dictionary = {"Sorcerer": 1, "Priest": 0, "Enchanter": 2}
var selection_costs : Dictionary = {"Sorcerer": 1, "Priest": 0, "Enchanter": 3}
...
var sounds : Array = ['energy blast.wav', 'boink.wav']
...
static func get_damage_roll(_power : int, _casterchar) :
	var base_damage = randi_range(1, 5)
	return base_damage
