...
var school_levels : Dictionary = {"Sorcerer": 2, "Priest": 2, "Enchanter": 0}
var selection_costs : Dictionary = {"Sorcerer": 3, "Priest": 3, "Enchanter": 0}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = false
var in_combat : bool = true
var description : String = 'Itching Skin:  Decreases the ability of the target to hit during combat.'
