...
var schools : Array = ['Sorcerer', 'Enchanter', 'Priest']

# Fuction of target type, effect (phase), and line of sight
var targettile : int = 0  #0=anywhere 1=creature 2=empty 3=nowall

var school_levels : Dictionary = {"Sorcerer": 3, "Priest": 5, "Enchanter": 5}
var selection_costs : Dictionary = {"Sorcerer": 6, "Priest": 15, "Enchanter": 15}
