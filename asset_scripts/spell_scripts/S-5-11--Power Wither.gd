...
var school_levels : Dictionary = {"Sorcerer": 5, "Priest": 0, "Enchanter": 5}
var selection_costs : Dictionary = {"Sorcerer": 15, "Priest": 0, "Enchanter": 15}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = false
var in_combat : bool = true
var description : String = 'Power Wither:  Will cause the affected targets to lose spell points each round during combat.'
