...
var school_levels : Dictionary = {"Sorcerer": 6, "Priest": 0, "Enchanter": 7}
var selection_costs : Dictionary = {"Sorcerer": 21, "Priest": 0, "Enchanter": 28}
