var name : String = 'Dart of Terror'

var attributes : Array = ['Magical','Projectile']
var tags : Array = ['Magical']

var schools : Array = ['Special/ProJo/Breath']
...
var description : String = 'Dart of Terror'

var resist : int = 0 #ignores resistances and dodge 
var los : bool = true # line of sight
var ray : bool = false
var rot : bool = false
var proj_tex : String = 'Dart'
var proj_hit : String = 'Web'
var sounds : Array = ['43', 'bombom.wav']
...
static func get_duration_roll(_power : int, __casterchar) -> int:
	var base_duration = randi_range(2, 10)
...
static func get_damage_roll(_power : int, _casterchar) :
	var base_damage = randi_range(1, 2)
	return base_damage
