...
var schools : Array = ['Special/Potion', 'Sorcerer', 'Priest']

# Fuction of target type, effect (phase), and line of sight
var targettile : int = 3  #0=anywhere 1=creature 2=empty 3=nowall

var school_levels : Dictionary = {"Sorcerer": 3, "Priest": 4, "Enchanter": 0}
var selection_costs : Dictionary = {"Sorcerer": 6, "Priest": 10, "Enchanter": 0}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = true
var in_combat : bool = true
var description : String = 'Adrenalin'
...
var sounds : Array = ['boink.wav', 'pops.wav']
...
static func get_duration_roll(_power : int, __casterchar) -> int:
	var base_duration = randi_range(4, 8)
