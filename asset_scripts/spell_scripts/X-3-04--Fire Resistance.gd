var name : String = 'Fire Resistance'

var attributes : Array = ['Magical','Misc']
var tags : Array = ['Magical']

var schools : Array = ['Special/Potion']
...
var description : String = 'Fire Resistance'
...
var sounds : Array = ['small explode.wav', 'electric energize.wav']
...
static func get_duration_roll(_power : int, __casterchar) -> int:
	var base_duration = randi_range(5, 12)
