...
var school_levels : Dictionary = {"Sorcerer": 0, "Priest": 4, "Enchanter": 0}
var selection_costs : Dictionary = {"Sorcerer": 0, "Priest": 10, "Enchanter": 0}
...
var sounds : Array = ['resurrect death.wav', 'big splat.wav']
