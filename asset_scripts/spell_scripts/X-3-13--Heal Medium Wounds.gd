var name : String = 'Heal Medium Wounds'

var attributes : Array = ['Magical','Special']
var tags : Array = ['Magical','Healing']

var schools : Array = ['Special/Potion', 'Priest', 'Sorcerer']

# Fuction of target type, effect (phase), and line of sight
var targettile : int = 3  #0=anywhere 1=creature 2=empty 3=nowall

var school_levels : Dictionary = {"Sorcerer": 6, "Priest": 2, "Enchanter": 0}
var selection_costs : Dictionary = {"Sorcerer": 21, "Priest": 3, "Enchanter": 0}
var max_plevel : int = 7 # Is this ever not 7?
var in_field : bool = true
var in_combat : bool = true
var description : String = 'Heal Medium Wounds'
...
var sounds : Array = ['slurpy.wav', 'hit bumper.wav']
...
static func get_damage_roll(_power : int, _casterchar) :
	var base_damage = randi_range(2, 16)
	return base_damage
