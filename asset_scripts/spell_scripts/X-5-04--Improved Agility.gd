var name : String = 'Improved Agility'

var attributes : Array = ['Magical','Misc']
var tags : Array = ['Magical']

var schools : Array = ['Special/ImproveMissile', 'Special/ImproveMissile']
...
var description : String = 'Improved Agility'
...
var sounds : Array = ['jump.wav', 'identify.wav']
