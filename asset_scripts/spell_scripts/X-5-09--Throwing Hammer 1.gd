var name : String = 'Throwing Hammer +1'

var attributes : Array = ['Magical','Projectile']
var tags : Array = ['Magical']

var schools : Array = ['Special/ImproveMissile']
...
var description : String = 'Throwing Hammer +1'
...
static func get_damage_roll(_power : int, _casterchar) :
	var base_damage = randi_range(2, 7)
	return base_damage
