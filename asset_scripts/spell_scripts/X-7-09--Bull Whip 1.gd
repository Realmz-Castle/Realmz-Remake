var name : String = 'Bull Whip +1'

var attributes : Array = ['Magical','Misc']
var tags : Array = ['Magical']

var schools : Array = ['Special/Unnamed']
...
var description : String = 'Bull Whip +1'
...
var sounds : Array = ['sting.wav', 'smack.wav']
...
static func get_damage_roll(_power : int, _casterchar) :
	var base_damage = randi_range(2, 5)
	return base_damage
