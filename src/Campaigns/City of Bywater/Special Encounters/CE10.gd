...
var detected_trap_flag_stuff_done : String = 'ce10_detect'
var detected_trap_success_flag_stuff_done : String = 'ce10_detect_success'
var disabled_trap_flag_stuff_done : String = 'ce10_disable'
var disabled_trap_success_flag_stuff_done : String = 'ce10_disable_success'
var picked_trap_flag_stuff_done : String = 'ce10_picked'
...
func result1() :
	var text : String = "You discover one tome to be very different than the rest.  It appears to be magical.  You easily slip it under your clothing and make off with your theft."
	await ScriptHelperFuncsClass.display_text_wait_noise(text,'message nod.wav')
	ScriptHelperFuncsClass.give_treasure_with_id(4)
	#New function
	await change_map_rect(6, 16, 0, "BTL0", "BTL0")
