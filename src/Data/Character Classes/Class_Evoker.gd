const classrace_name : String = "Evoker"
...
static func get_selection_cost(_character, _spell, _cost) :
	return _spell.selection_costs.get("Enchanter", _cost)
