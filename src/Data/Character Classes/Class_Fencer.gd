const classrace_name : String = "Fencer"
...
static func _level_up(_character, _new_level : int) :
	...
	# ADD APR AT LEVEL
	if [4,7,10,13,16,19,22].has(_new_level) :
...
static func _character_creation_gifts(_character) :
	...
	for name in ["Tip Sword","Dagger","Leather Armor","Leather Gloves","Leather Boots"] :
