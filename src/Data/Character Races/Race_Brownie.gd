const classrace_name : String = "Brownie"
...
const base_stat_bonuses : Dictionary = {
	...
	"MultiplierPhysical" : 0.925,
	"MultiplierFire" : 1.0,
	"MultiplierIce" : 0.925,
	"MultiplierElect" : 1.10,
	"MultiplierPoison" : 1.10,
	"MultiplierChemical" : 1.10,
	"MultiplierDisease" : 1.10,
	"MultiplierMagic" : 0.95,
	"MultiplierHealing" : -1.0,
	
	"MultiplierMental" : 0.875,
	
	"Melee_Crit_Rate" : -10.0,
	"Melee_Crit_Mult" : 0.0,
