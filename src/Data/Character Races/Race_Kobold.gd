const classrace_name : String = "Kobold"
...
const base_stat_bonuses : Dictionary = {
	...
	"MultiplierPhysical" : 0.90,
	"MultiplierFire" : 0.825,
	"MultiplierIce" : 0.85,
	"MultiplierElect" : 0.90,
	"MultiplierPoison" : 0.925,
	"MultiplierChemical" : 0.925,
	"MultiplierDisease" : 0.925,
	"MultiplierMagic" : 0.925,
