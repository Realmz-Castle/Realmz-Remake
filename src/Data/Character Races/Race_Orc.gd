const classrace_name : String = "Orc"
const classrace_types : Array = ["Goblinoid Races"]
...
const base_stat_bonuses : Dictionary = {
	...
	"ResistanceIce" : -5.0,
	"ResistanceElect" : -5.0,
	"ResistancePoison" : -5.0,
	"ResistanceChemical" : -5.0,
	"ResistanceDisease" : -5.0,
	"ResistanceMagic" : 2.5,
	"ResistanceHealing" : 0.0,
	"ResistanceMental" : 2.5,
	
	"MultiplierPhysical" : 1.0,
	"MultiplierFire" : 1.025,
	"MultiplierIce" : 1.05,
	"MultiplierElect" : 1.05,
	"MultiplierPoison" : 1.05,
	"MultiplierChemical" : 1.05,
	"MultiplierDisease" : 1.05,
