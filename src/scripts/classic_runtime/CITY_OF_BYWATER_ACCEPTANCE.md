...
The generic profile roster also opens before any campaign catalog is active.
Valid campaign-owned item payloads now remain deferred without changing their
stable definition or instance IDs. Loading City rehydrates items 806 and 807
into the profile character, while the saved campaign party independently
restores them for Continue.
