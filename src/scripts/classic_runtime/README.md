...
Native profile/save integration remains separate. `ClassicRuntimeState` snapshots are currently standalone; a shipping integration must bridge Classic quest, tile, trigger, priest-turning, encounter, and position state into Remake's save lifecycle.
