...
Compiler-produced monsters retain permanent Classic spell-protection conditions 16 through 20 as a compatibility-owned screen level. Combat resolves the cast spell's learned or exact Classic level before ordinary magic resistance, matching Classic's rule that a screen stops spells at or below its level. Positive screen durations still require a round-based condition lifecycle, and other nonzero starting conditions remain installation blockers.
