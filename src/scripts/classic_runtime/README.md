...
The spoken-word variant opens Remake's speech input for the City of Bywater archives and verifies that `WATERFORD` selects the source-backed Result 1 messages:
