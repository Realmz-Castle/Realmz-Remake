...
var tags : Array = ['Magical', 'Ice', 'Terrain', 'Wall']
...
var description : String = 'Damage : 2-10 x Power\\n  Range : 10\\n  Target : Can Rotate\\n   Sight : Yes\\n  Duration : 1-4 Rounds\\n  SP Cost : Power x 9'
...
var sounds : Array = ['hit effect 5.wav','electric energize.wav']
var places_terrain : bool = true
var terrain_tex : String = 'Ice'
